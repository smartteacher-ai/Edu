      ...
      <div className="bg-gradient-to-br from-indigo-50 to-white p-6 rounded-xl border border-indigo-100 shadow-sm relative overflow-hidden">
        ...
        {aboutLang === 'en' ? (
          ...
          <div className="space-y-3 text-gray-700 text-sm md:text-base leading-relaxed" dir="rtl">
            <p><strong>EduGenius AI</strong> هو مساعدك الذكي لتلخيص وصناعة المحتوى التعليمي، مصمم لمساعدة المعلمين والمدربين والطلاب على توفير الوقت وتحسين جودة التعليم.</p>
            <ul className="list-disc pr-5 space-y-1">
              ...
              <li><strong>الاستخراج:</strong> تفريغ واستخراج النصوص بدقة متناهية. يدعم اللغة العربية بشكل كامل، بما في ذلك القرآن الكريم بالتشكيل، الفصحى، والعامية.</li>
